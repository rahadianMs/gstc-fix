// app/components/ResourceAdminPage.jsx
"use client";
...
export default function ResourceAdminPage({ supabase, user, setActiveDashboardPage }) {
    ...
    const handleDelete = async (resourceId) => {
        const isConfirmed = window.confirm("Apakah Anda yakin ingin menghapus materi ini?");
        if (isConfirmed) {
